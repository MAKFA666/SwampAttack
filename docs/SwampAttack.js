...
// include: C:\Users\CURRRO~1\AppData\Local\Temp\tmpn_innfb9.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'SwampAttack.data';
      var REMOTE_PACKAGE_BASE = 'SwampAttack.data';
...
Module['FS_createPath']("/", "assets", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_SwampAttack.data');
      }
      Module['addRunDependency']('datafile_SwampAttack.data');
    ...
    loadPackage({"files": [{"filename": "/assets/ammo.png", "start": 0, "end": 293452}, {"filename": "/assets/arial.ttf", "start": 293452, "end": 1310176}, {"filename": "/assets/background.png", "start": 1310176, "end": 2029727}, {"filename": "/assets/bullet.png", "start": 2029727, "end": 2031922}, {"filename": "/assets/health.png", "start": 2031922, "end": 2850815}, {"filename": "/assets/player.png", "start": 2850815, "end": 2949801}, {"filename": "/assets/rapid.png", "start": 2949801, "end": 3292227}, {"filename": "/assets/zombie.png", "start": 3292227, "end": 3378673}], "remote_package_size": 3378673});

  })();

// end include: C:\Users\CURRRO~1\AppData\Local\Temp\tmpn_innfb9.js
// include: C:\Users\CURRRO~1\AppData\Local\Temp\tmpyj3xe84b.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\CURRRO~1\AppData\Local\Temp\tmpyj3xe84b.js
// include: C:\Users\CURRRO~1\AppData\Local\Temp\tmp_gptkdlm.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\CURRRO~1\AppData\Local\Temp\tmp_gptkdlm.js
...
function findWasmBinary() {
  return locateFile('SwampAttack.wasm');
}
